		...
		while (play == true) {
			...
			case 2:
				...
				if (choice2.equalsIgnoreCase("face the beast")) {
					state = 3; // this is not taking our if statement to be true
								// and we are moving to else
				} else {
					play = false;
					System.out.println("Okay! Have a great day!");
					break;
			...
			case 3:
				System.out
						.println("You approach the dragon.  You see that he has ___ heads.  (Enter one, two or three)");
			...
			case 5:
				System.out.println(
						"Armed with your weapon of choice, you approach the dragon!  You can feel its fiery breath as you get closer.  It stares at you with its __ eyes.  (enter red or blue)");
